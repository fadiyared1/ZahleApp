package com.example.menu.ui.Restaurants;
...
public class RestaurantsFragment extends Fragment {
    ...
    MyRestaurantAdapter myRestaurantAdapter;
    Intent myIntent;
    View root;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        downloadJSON("http://192.168.1.103:8000/restaurants");
        return root;
    ...
    private void loadIntoListView(String json) throws JSONException {
        ...
        myRestaurantData = new MyRestaurantData[jsonArray.length()];
        ...
        myRestaurantAdapter = new MyRestaurantAdapter(myRestaurantData, RestaurantsFragment.super.getActivity());
