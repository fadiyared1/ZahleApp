...
import com.example.menu.ui.Nightlife.NightlifeFragment;
...
public class HotelsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        downloadJSON("http://192.168.1.103:8000/hotels");
        return root;
    ...
    private void loadIntoListView(String json) throws JSONException {
        ...
        myRestaurantAdapter = new MyRestaurantAdapter(myRestaurantData, HotelsFragment.super.getActivity());
