...
import com.example.menu.ui.Hotels.HotelsFragment;
 ...
 * Use the {@link TraditionalHouseFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class TraditionalHouseFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        downloadJSON("http://192.168.1.103:8000/houses");
        return root;
    ...
    private void loadIntoListView(String json) throws JSONException {
        ...
        myRestaurantAdapter = new MyRestaurantAdapter(myRestaurantData, TraditionalHouseFragment.super.getActivity());
